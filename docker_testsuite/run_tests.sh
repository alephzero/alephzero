...
docker build -t alephzero_testsuite_alpine_3.10_clang -f alpine_3.10_clang.Dockerfile ..
...
echo -e "\e[1m\e[92mTesting on alpine:3.10 clang\e[0m"
docker run --rm -it alephzero_testsuite_alpine_3.10_clang
