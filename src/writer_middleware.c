...
A0_STATIC_INLINE
errno_t a0_writer_middleware_add_time_wall_header_process(void* data, a0_packet_t* pkt, a0_writer_middleware_chain_t chain) {
  A0_MAYBE_UNUSED(data);
...
A0_STATIC_INLINE
void a0_writer_middleware_add_writer_id_header_init(void** data) {
...
A0_STATIC_INLINE
errno_t a0_writer_middleware_add_writer_id_header_close(void* data) {
  free(data);
  return A0_OK;
}
...
A0_STATIC_INLINE
void a0_writer_middleware_add_writer_seq_header_init(void** data) {
...
A0_STATIC_INLINE
errno_t a0_writer_middleware_add_writer_seq_header_close(void* data) {
  free(data);
  return A0_OK;
}

A0_STATIC_INLINE
errno_t a0_writer_middleware_add_writer_seq_header_process(void* data, a0_packet_t* pkt, a0_writer_middleware_chain_t chain) {
...
a0_writer_middleware_t a0_writer_middleware_add_standard_headers() {
  a0_writer_middleware_t tmp0;
  a0_writer_middleware_compose(
      a0_writer_middleware_add_time_mono_header(),
      a0_writer_middleware_add_time_wall_header(),
      &tmp0);

  a0_writer_middleware_t tmp1;
  a0_writer_middleware_compose(
      tmp0,
      a0_writer_middleware_add_writer_id_header(),
      &tmp1);

  a0_writer_middleware_t tmp2;
  a0_writer_middleware_compose(
      tmp1,
