...
a0_err_t a0_deadman_topic_open(a0_deadman_topic_t topic, a0_file_t* file) {
  ...
  opts.create_options.size = sizeof(a0_deadman_mtx_shared_token_t);
...
a0_err_t a0_deadman_init(a0_deadman_t* d, a0_deadman_topic_t topic) {
  ...
  return a0_deadman_mtx_init(
      &d->_deadman_mtx,
      (a0_deadman_mtx_shared_token_t*)d->_file.arena.buf.data);
}

a0_err_t a0_deadman_close(a0_deadman_t* d) {
  a0_deadman_mtx_shutdown(&d->_deadman_mtx);
  a0_deadman_release(d);
  return a0_file_close(&d->_file);
}

a0_err_t a0_deadman_take(a0_deadman_t* d) {
  return a0_deadman_mtx_lock(&d->_deadman_mtx);
}

a0_err_t a0_deadman_trytake(a0_deadman_t* d) {
  return a0_deadman_mtx_trylock(&d->_deadman_mtx);
}

a0_err_t a0_deadman_timedtake(a0_deadman_t* d, a0_time_mono_t* timeout) {
  return a0_deadman_mtx_timedlock(&d->_deadman_mtx, timeout);
}

a0_err_t a0_deadman_release(a0_deadman_t* d) {
  return a0_deadman_mtx_unlock(&d->_deadman_mtx);
}
...
a0_err_t a0_deadman_timedwait_taken(a0_deadman_t* d, a0_time_mono_t* timeout, uint64_t* out_tkn) {
  a0_err_t err = a0_deadman_mtx_timedwait_locked(&d->_deadman_mtx, timeout, out_tkn);
  return err;
}
...
a0_err_t a0_deadman_state(a0_deadman_t* d, a0_deadman_state_t* out_state) {
  return a0_deadman_mtx_state(&d->_deadman_mtx, out_state);
}
