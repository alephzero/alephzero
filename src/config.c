...
A0_STATIC_INLINE
errno_t _a0_config_topic_open(a0_config_topic_t topic, a0_file_t* out) {
...
errno_t a0_config(a0_config_topic_t topic,
                  a0_alloc_t alloc,
                  int flags,
                  a0_packet_t* out) {
  a0_file_t file;
...
errno_t a0_write_config(a0_config_topic_t topic, a0_packet_t pkt) {
  a0_file_t file;
  A0_RETURN_ERR_ON_ERR(_a0_config_topic_open(topic, &file));

  a0_writer_t writer;
  errno_t err = a0_writer_init(&writer, file.arena);
  if (err) {
    a0_file_close(&file);
    return err;
  }
...
errno_t a0_onconfig_init(a0_onconfig_t* cfg,
...
errno_t a0_onconfig_close(a0_onconfig_t* cfg) {
